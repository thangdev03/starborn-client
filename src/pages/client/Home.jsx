...
const Home = () => {
  ...
  return (
    <Box>
        ...
        {/* ---------------------COLLECTIONS SECTION---------------------- */}
        <Grid container width={'100%'} marginTop={'60px'} columnSpacing={{md: '16px'}} rowSpacing={{md: '12px'}}>
            <Grid item xs={12} position={'relative'}>
                ...
                >
                    <Typography 
                    fontSize={{xs: '24px', md: '36px'}} fontWeight={600} color={'white'}
                    sx={{
                       marginBottom: '20px',
                       flexGrow: 1,
                       textAlign: 'center',
            ...
            <Grid item xs={12} sm={6} position={'relative'}>
                ...
                sx={{
                    ...
                    top: { xs: '50%', sm: '10%' },
                    left: { xs: '50%', sm: '10%' },
                    transform: { xs: 'translateX(-50%) translateY(-50%)', sm: 'none' },
                }}
                >
                    <Typography 
                    fontSize={{xs: '24px', md: '36px'}} fontWeight={600} color={'white'}
                    ...
                    <Stack direction={'row'} justifyContent={{ xs: 'center', sm: 'start'}} flexShrink={0}>
                        <RedButton
                            title={'KHÁM PHÁ NGAY'}
                        />
                    </Stack>
        ...
        {/* ---------------------POLICIES SECTION------------------------ */}
        <Stack direction={'row'} marginTop={'80px'} justifyContent={'space-around'} flexWrap={'wrap'} gap={'20px'}>
            <Stack alignItems={'center'}>
                <Box sx={{ bgcolor: 'rgba(27, 33, 65, 0.2)', padding: '8px', borderRadius: '100%', flexGrow: 0, width: 'fit-content' }}>
                    <Stack justifyContent={'center'} alignItems={'center'} sx={{ bgcolor: colors.primaryColor, width: '60px', height: '60px', borderRadius: '100%' }}>
                        <LocalShippingOutlinedIcon sx={{ color: 'white', fontSize: '36px' }}/>
                    </Stack>
                </Box>
                <Typography sx={{ mt: '16px', fontSize: '20px', fontWeight: 600 }}>MIỄN PHÍ GIAO HÀNG</Typography>
                <Typography sx={{ mt: '8px', fontSize: '14px' }}>cho tất cả các đơn trên 200.000đ</Typography>
            </Stack>

            <Stack alignItems={'center'}>
                <Box sx={{ bgcolor: 'rgba(27, 33, 65, 0.2)', padding: '8px', borderRadius: '100%', flexGrow: 0, width: 'fit-content' }}>
                    <Stack justifyContent={'center'} alignItems={'center'} sx={{ bgcolor: colors.primaryColor, width: '60px', height: '60px', borderRadius: '100%' }}>
                        <SupportAgentOutlinedIcon sx={{ color: 'white', fontSize: '36px' }}/>
                    </Stack>
                </Box>
                <Typography sx={{ mt: '16px', fontSize: '20px', fontWeight: 600 }}>HỖ TRỢ 24/7</Typography>
                <Typography sx={{ mt: '8px', fontSize: '14px' }}>hỗ trợ khách hàng 24/7 và thân thiện</Typography>
            </Stack>

            <Stack alignItems={'center'}>
                <Box sx={{ bgcolor: 'rgba(27, 33, 65, 0.2)', padding: '8px', borderRadius: '100%', flexGrow: 0, width: 'fit-content' }}>
                    <Stack justifyContent={'center'} alignItems={'center'} sx={{ bgcolor: colors.primaryColor, width: '60px', height: '60px', borderRadius: '100%' }}>
                        <VerifiedUserOutlinedIcon sx={{ color: 'white', fontSize: '36px' }}/>
                    </Stack>
                </Box>
                <Typography sx={{ mt: '16px', fontSize: '20px', fontWeight: 600 }}>CHÍNH SÁCH ĐỔI TRẢ</Typography>
                <Typography sx={{ mt: '8px', fontSize: '14px' }}>miễn phí đổi trả trong vòng 7 ngày</Typography>
            </Stack>
        </Stack>
    </Box>
  )
