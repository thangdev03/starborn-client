...
import { Box, Stack, Typography, List, InputBase, ListItemButton, IconButton, Avatar, Drawer, Button, Icon, Paper, ListItem, ListItemText } from '@mui/material'
      ...
      >
        ...
        >
          ...
          >
            ...
            <MobileNavItem title={"Bộ sưu tập"} href={"/"} />
            <MobileNavItem title={"Nam"} href={"/nam"} />
            <MobileNavItem title={"Nữ"} href={"/nu"} />
            <MobileNavItem title={"Đồ thể thao"} href={"/"} />
            <MobileNavItem title={"Mặc hàng ngày"} href={"/"} />
          </List>
          <ListItemButton
            href="/"
            sx={{
